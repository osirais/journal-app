        ...
        <form className="flex min-w-64 flex-1 flex-col">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex justify-center gap-3">
              <motion.div
                initial={{ width: 180 }}
                animate={{ width: hoveredProvider === "google" ? 180 : 38 }}
                onMouseEnter={() => setHoveredProvider("google")}
              >
                <Button
                  onClick={() => signInWithOAuth("google")}
                  size="icon"
                  className="flex w-full items-center justify-start gap-2 overflow-hidden px-2"
                >
              ...
              <motion.div
                initial={{ width: 38 }}
                animate={{ width: hoveredProvider === "github" ? 180 : 38 }}
                onMouseEnter={() => setHoveredProvider("github")}
              >
                <Button
                  onClick={() => signInWithOAuth("github")}
                  size="icon"
                  className="flex w-full items-center justify-start gap-2 overflow-hidden px-1"
                >
